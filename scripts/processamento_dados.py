...
class Dados:
    ...
    def join(dadosA, dadosB):
        ...
        return Dados(combine_list, 'list')
    

    def transformando_dados_tabela(self):
    
        dados_comninados_tabela = [self.nome_colunas]
    ...
    def salvando_dados(self, path):
        ...
        dados_comninados_tabela = self.transformando_dados_tabela()

        with open(path, 'w') as file:
            writer = csv.writer(file)
            writer.writerows(dados_comninados_tabela)
